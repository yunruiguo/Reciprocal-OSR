...
class wide_encoder(nn.Module):
    def __init__(self, image_size, image_channels, latent_size, depth, widen_factor, dropout_rate, num_classes=2, num_rp_per_cls=8):
        ...
        self.conv1 = conv3x3(image_channels, nStages[0])
